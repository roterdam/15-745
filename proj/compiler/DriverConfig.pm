...
our $COMPILER_ARGS  = "-l 15411c1.h0";
our @LEXTS          = reverse map {"l$_"} (1 .. $LAB);  # source filename extensions
our $GCC            = "gcc -m64";     # gcc executable and default flags
our $RUNTIME        = "15411c1.c $rt_stem.c";   # runtime system for linking against asm file

my $c0_level = 6 - $LAB;
our $REF_COMPILER = "/afs/cs.cmu.edu/academic/class/15411-f14/bin/cc0";
our $AUTOGRADE_REF_COMPILER = "../reference/bin/cc0";
our $REF_COMPILER_ARGS = " -l conio -l string -l file -l 15411 ";
...
my $MAX_SCORE0 = 40;        # maximal score for compiler, test suite 0
...
my $TESTS2_N = 10;      # first n failing suite 2 tests...
